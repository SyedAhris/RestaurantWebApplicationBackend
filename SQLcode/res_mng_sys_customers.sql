...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`cust_id`),
  CONSTRAINT `check_cust_no` CHECK (((`cust_number` like _utf8mb4'03%') and (length(`cust_number`) = 11))),
  CONSTRAINT `check_pass` CHECK ((length(`cust_password`) >= 8)),
  CONSTRAINT `chk_email` CHECK ((`cust_email` like _utf8mb4'%_@__%.__%'))
