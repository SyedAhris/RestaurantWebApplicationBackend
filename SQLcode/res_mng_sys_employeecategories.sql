...
CREATE TABLE `employeecategories` (
  `emp_cat_id` int NOT NULL AUTO_INCREMENT,
  `emp_cat_name` varchar(255) NOT NULL,
  PRIMARY KEY (`emp_cat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `employeecategories`
--

LOCK TABLES `employeecategories` WRITE;
/*!40000 ALTER TABLE `employeecategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `employeecategories` ENABLE KEYS */;
UNLOCK TABLES;
